...
const coresPorGrupo = {
    neurologicos: "#FF6F61", // Exemplo: Cor vermelha para sintomas neurológicos
    respiratorios: "#6B5B95", // Exemplo: Cor roxa para sintomas respiratórios
    digestivos: "#88B04B", // Exemplo: Cor verde para sintomas digestivos
    musculoesqueléticos: "#F7CAC9", // Exemplo: Cor rosa para sintomas musculoesqueléticos
    "cardiacos-circulatorios": "#F7CAC9", // Exemplo: Cor rosa para sintomas cardíacos/circulatórios
    dermatologicos: "#88B04B", // Exemplo: Cor verde para sintomas dermatológicos
    "infecciosos-febris": "#88B04B", // Exemplo: Cor verde para sintomas infecciosos/febris
    "ginecologicos-congenitos": "#88B04B", // Exemplo: Cor verde para sintomas ginecológicos/congênitos
    "sistemicos-gerais": "#848484" // Exemplo: Cor cinza para sintomas sistêmicos gerais
};
